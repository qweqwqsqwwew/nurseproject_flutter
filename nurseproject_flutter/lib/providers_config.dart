import 'package:nurseproject_flutter/pages/AppHomePage/Home/provider/homeBannerData.p.dart';
...
import 'pages/AppHomePage/Home/provider/homeBannerData.p.dart';
...
List<SingleChildWidget> providersConfig = [
  ...
  ChangeNotifierProvider<homeBannerData>.value(value: homeBannerData()),
];
