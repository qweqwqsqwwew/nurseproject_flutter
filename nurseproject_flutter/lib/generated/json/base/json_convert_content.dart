...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case OrderModelEntity:
			...
			return orderModelListFromJson(data as OrderModelList, json) as T;    }
    return data as T;
  }
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case OrderModelEntity:
			...
			return orderModelListToJson(data as OrderModelList);    }
    return data as T;
  }
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'OrderModelEntity':
			...
			return OrderModelList().fromJson(json);    }
    return null;
  }
