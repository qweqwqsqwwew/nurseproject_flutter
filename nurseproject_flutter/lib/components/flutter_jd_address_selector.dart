...
class _JDAddressDialogState extends State<JDAddressDialog>
  ...
  void initState() {
    ...
    _tabController = TabController(vsync: this, length: widget.titleArr == null?myTabs.length:1);
  ...
  Widget _judgeTitleArr(){
    if(widget.titleArr == null){
      return Container(
          color: Colors.white,
  ...
  void _initData() async {
    ...
    rootBundle
        .loadString(
            'asset/files/chinese_cities.json')
        .then((value) {
